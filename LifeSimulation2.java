...
How to run:     1. javac LifeSimulation2.java     2. java LifeSimulation2  (Should return tests for LifeSimulations (Not part of the project, but still helpful))
*/
...
public class LifeSimulation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //Uncomment this code and comment the code above to get the amount of live cells and the sample statistic(See graph in report.)
